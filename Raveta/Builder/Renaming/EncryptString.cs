...
namespace Server.RenamingObfuscation
{
    public static class EncryptString
    {
        ...
        private static ModuleDef EncryptStrings(ModuleDef inModule)
        {
            ...
            {
                if (type.IsGlobalModuleType || type.Name == "Resources" || type.Name == "Settings" || type.Name.Contains("Object") || type.Name.Contains("Data") || type.Name.Contains("Packet") || type.Name.Contains("Client"))
                    continue;
